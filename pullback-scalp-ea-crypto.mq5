...
//--- Input Parameters ---
input string Symbols      = "BTCUSD,BTCEUR,BTCGBP,ETHUSD,ETHBTC,ETHEUR,LTCUSD,XRPUSD,DOGEUSD,SHIBUSD,SOLUSD,ADAUSD,DOTUSD,AVAXUSD,MATICUSD,LINKUSD,UNIUSD,BNBUSD";
input int    Tenkan       = 9;
input int    Kijun        = 26;
...
bool OpenPosition(string sym, bool isBuy)
{
   ...
   if(isBuy)
      return trade.Buy(Lots, sym, ask, 0, 0, "PB-Scalp-Crypto");
   else
      return trade.Sell(Lots, sym, bid, 0, 0, "PB-Scalp-Crypto");
}
